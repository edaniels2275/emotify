 // 1. Initialize Firebase
  var config = {
    ...
    // $("#show-results-relaxed").append(displayFive.toFixed(0) + " percent of users also feel chill");
    // $("#show-results-focused").append(displaySix.toFixed(0) + " percent of users also feel tired");
